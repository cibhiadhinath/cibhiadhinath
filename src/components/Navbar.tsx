        ...
        >
            <div className="bg-[#050505]/60 backdrop-blur-2xl border border-white/10 rounded-full px-5 py-2.5 flex items-center justify-between">
                ...
                <button
                    ...
                    className="hidden md:inline-flex shrink-0 px-5 py-2 bg-white text-black rounded-full text-[13px] font-bold tracking-wide hover:scale-105 active:scale-95 transition-all duration-300 ml-4"
                >
                    Let's Talk
                </button>
